...
def build_dinov3_or_fallback(patch_size: int = 16, image_size: int = 224):
    """Return a DINOv3 feature extractor if locally available, otherwise fallback.
    ...
    return build_feature_extractor("dinov3", patch_size=patch_size, image_size=image_size)
