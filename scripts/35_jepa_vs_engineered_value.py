...
from sensor_jepa.train.jepa_vs_engineered_value import run_jepa_vs_engineered_value
...
def main() -> None:
    ...
    parser.add_argument("--out-root", default="outputs/sensor_jepa/jepa_vs_engineered_value")
    args = parser.parse_args()

    cfg = load_config(args.config)
    paths = run_jepa_vs_engineered_value(
        cfg,
