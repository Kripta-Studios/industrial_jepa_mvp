...
T = {
    "es": {
        ...
        "hero_badges": ["Visión + sensores", "DINOv2 + PatchCore", "Risk scoring", "Piloto 4-6 semanas"],
        ...
        "evidence_title": "Resultados actuales que sí sirven para vender un piloto",
        "evidence_subtitle": "Validación interna con datos públicos industriales: visión muy fuerte para inspección y sensor útil cuando los proxies de ciclo no bastan.",
        ...
        "results": [
            ("Pixel baseline", "0.60", "AUPRC", "Control visual simple"),
            ("DINOv2 + PatchCore", "1.00", "AUPRC", "Quick run MVTec bottle"),
            ("ResNet18 + PatchCore", "0.999", "AUPRC", "Quick run MVTec bottle"),
            ("Sensor engineered", "0.558", "AUPRC", "No-cycle CNC"),
            ("Señal aprendida futura", "0.550", "AUPRC", "No-cycle CNC"),
            ("Hardness/material sensores", "0.763", "AUPRC", "Held-out hardness"),
            ("Sensores + señal aprendida", "0.720", "AUPRC", "Held-out hardness"),
            ("Delta JEPA sobre engineered", "+0.035", "AUPRC", "Mejor caso hardness"),
        ],
        ...
        "machine_kpis": [
            ("Operational metadata + future signal", "0.701", "AUPRC, h=3/K=10"),
            ("No-cycle sensor engineered", "0.558", "AUPRC sin proxies de ciclo"),
            ("No-cycle predicted future", "0.550", "AUPRC señal latente futura"),
            ("Held-out hardness sensor engineered", "0.763", "AUPRC cambio material/dureza"),
        ],
    ...
    "en": {
        ...
        "hero_badges": ["Vision + sensors", "DINOv2 + PatchCore", "Risk scoring", "4-6 week pilot"],
        "hero_title": "Industrial Predictive Quality MVP",
        ...
        "evidence_title": "Current results that support selling a pilot",
        "evidence_subtitle": "Internal validation on public industrial data: strong visual inspection signal and useful sensor signal when cycle proxies are not enough.",
        "visual_evidence": "Visual MVTec bottle quick",
        "sensor_evidence": "Sensor CNC no-cycle",
        "hardness_evidence": "Hardness/material split",
        ...
        "results": [
            ("Pixel baseline", "0.60", "AUPRC", "Simple visual control"),
            ("DINOv2 + PatchCore", "1.00", "AUPRC", "Quick run MVTec bottle"),
            ("ResNet18 + PatchCore", "0.999", "AUPRC", "Quick run MVTec bottle"),
            ("Sensor engineered", "0.558", "AUPRC", "No-cycle CNC"),
            ("Future learned signal", "0.550", "AUPRC", "No-cycle CNC"),
            ("Hardness/material sensors", "0.763", "AUPRC", "Held-out hardness"),
            ("Sensors + learned signal", "0.720", "AUPRC", "Held-out hardness"),
            ("JEPA delta over engineered", "+0.035", "AUPRC", "Best hardness case"),
        ],
        ...
        "machine_kpis": [
            ("Operational metadata + future signal", "0.701", "AUPRC, h=3/K=10"),
            ("No-cycle sensor engineered", "0.558", "AUPRC without cycle proxies"),
            ("No-cycle predicted future", "0.550", "AUPRC future latent signal"),
            ("Held-out hardness sensor engineered", "0.763", "AUPRC material/hardness shift"),
        ],
